...
export default function SeleccionarMantenimientoEliminar() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        <h1 className="text-3xl font-bold mb-6 text-gray-800">Eliminar Mantenimiento</h1>
        <p className="text-gray-600 mb-6">Seleccione el mantenimiento que desea eliminar</p>
        ...
        <div className="mb-6">
          ...
          <input
            ...
            placeholder="ABC-123"
            className="px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 w-full max-w-xs uppercase"
          />
        </div>
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-sm text-center">
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          navigate(`/mantenimientos/eliminar/${mantenimiento.id}`);
                        }}
